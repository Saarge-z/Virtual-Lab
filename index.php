...
/* if(isset($_SESSION['incorrect']))
 ...
 if(isset($_SESSION['contact']))
 {
     ...
     ?>
     <script>alert("We have recieved your request");</script>
     <?php
 }
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){                    
                 ...
                 mysqli_stmt_bind_result($stmt, $id, $username, $password,$type);
                   ...
                   ?><script>alert("No account found with your credentials");</script><?php
                }
            } else{
                    ...
                    <div class="modal_body_contents">
                        ...
                        <div class="wrapper">
                            ...
                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>?id=signup" method="post">
                                ...
                                <div class="form-group ">
                                    <label>Type</label>
                                    <select onchange="chan(this.value)" name="type" class="form-control">
                                        <option>Student</option>
                                        <option>Teacher</option>
                                    </select>
                                </div>
                                <div class="form-group" id="chcode">
                                    <label>Referal Code</label>
                                    <input type="text" id="refcode" name="code" required class="form-control">
                                </div>
                                <div class="form-group">
